...
export const translations: Translations = {
  ...
  fatwaLajnah: {
    id: "Al-Lajnah Ad-Da'imah Fiqh Fatwa",
    en: "Al-Lajnah Ad-Da'imah Fiqh Fatwa",
    ar: 'فتاوى اللجنة الدائمة الفقهية',
  },
  islamicGuidance: {
    id: 'Islamic Guidance',
    en: 'Islamic Guidance',
  ...
  aqidahTauhid: {
    id: 'Aqidah and Tauhid',
    en: 'Aqidah and Tauhid',
    ar: 'العقيدة والتوحيد',
  },
  opinionSection: {
    id: 'Opinion',
...
export function translateCategory(
  ...
  const categoryMap: Record<string, { id: string; en: string; ar: string }> = {
    'saudi-arabia-terkini': { id: 'Saudi Arabia News', en: 'Saudi Arabia News', ar: 'أخبار المملكة العربية السعودية' },
    'dunia-islam': { id: 'Islamic World', en: 'Islamic World', ar: 'العالم الإسلامي' },
    'fatwa-fikih': { id: "Al-Lajnah Ad-Da'imah Fiqh Fatwa", en: "Al-Lajnah Ad-Da'imah Fiqh Fatwa", ar: 'فتاوى اللجنة الدائمة الفقهية' },
    'tuntunan-islam': { id: 'Islamic Guidance', en: 'Islamic Guidance', ar: 'الهداية الإسلامية' },
    'aqidah-tauhid': { id: 'Aqidah and Tauhid', en: 'Aqidah and Tauhid', ar: 'العقيدة والتوحيد' },
    'opini': { id: 'Opinion', en: 'Opinion', ar: 'آراء وتحليلات' },
    'ulama-warisan-ilmu': { id: 'Ulama & Warisan Ilmu', en: 'Scholars & Knowledge', ar: 'دروس العلماء' },
    'haramain-news': { id: 'Haramain News', en: 'Haramain News', ar: 'أخبار الحرمين' },
    'kajian-kitab': { id: 'Kajian Kitab', en: 'Islamic Books', ar: 'كتب إسلامية' },
